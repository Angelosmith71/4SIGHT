...
function BillingPageContent(){
  const{subscription,loading,openPortal}=useSubscription();const[pl,setPl]=useState(false);const sp=useSearchParams();const success=sp.get('success');const newPlan=sp.get('plan');
